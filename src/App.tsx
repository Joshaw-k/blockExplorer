            ...
            <div className="gap-6 space-y-3 gap-x-8 mb-3 block md:hidden">
              <div className="space-y-3">
                <div className="grid grid-cols-2 items-start">
                  ...
                  <span className="text-gray-900 font-bold text-xs sm:text-sm">Token</span>
                </div>
                <div className="grid grid-cols-2 items-start">
                  <span className="text-gray-900 text-xs sm:text-sm">Compiler Version</span>
                  <span className="text-gray-900 font-bold text-xs sm:text-sm">v0.8.9+commit.e5eed63a</span>
                </div>
              </div>
              <hr />
              <div className="space-y-3">
            ...
            <div className="bg-white rounded-lg border p-6 px-4 shadow-md">
              ...
              <div className="space-y-4">
                <div className='space-y-1.5'>
                  ...
                  <div className="flex items-center">
                    <FileText className='scale-75 text-gray-400' />
                    <a href="https://etherscan.io/address/0xe0b7ad7f8f26e2b00c8b47b5df370f15f90fcf48" className="text-[#0584C3] hidden sm:block lg:hidden xl:block hover:underline text-sm font-mono">
